...
<template>
  <figure class="aspect-square w-full relative overflow-hidden rounded-xl bg-gray-50">
    <div v-if="!imageLoaded" class="absolute inset-0 bg-gray-100 animate-pulse rounded-xl" />
